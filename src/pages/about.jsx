...
const AboutPage = () => {
  return (
    <div className="about-container p-8 max-w-4xl mx-auto bg-gray-900 text-white">
      ...
      <section className="important-members mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="member flex flex-col items-center text-center">
            <img
              src="https://assets.leetcode.com/users/avatars/avatar_1642515090.png"
              alt="Akram Khan"
            ...
            <a
              href="https://www.linkedin.com/in/itsmak/"
              target="_blank"
          ...
          <div className="member flex flex-col items-center text-center">
            ...
            <p className="text-lg text-gray-400">Co-Founder</p>
            <p className="text-base leading-relaxed mb-4">
              Abhinay, the young and visionary leader of Karyashala, leads the company with a focus on innovation and strategic growth. His dynamic leadership and commitment to excellence are driving Karyashala's success and shaping its future in the industry.
            </p>
            <a
              href="https://www.linkedin.com/in/abhinay-agrawal-3841371a4/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-400 hover:underline"
            >
      ...
      <section className="testimonials mb-12">
        ...
        <div className="testimonial mb-6">
          ...
          <p className="text-lg text-gray-400 mt-2">— Aditya, Software Engineer</p>
        </div>
        <div className="testimonial mb-6">
          ...
          <p className="text-lg text-gray-400 mt-2">— Shivam, Data Scientist</p>
        </div>
